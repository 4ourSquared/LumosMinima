...
Inoltre:
\begin{itemize}
    \item I membri di una classe dovrebbero essere dichiarata e/o definiti nel seguente ordine:
    \begin{itemize}
        ...
        \item Metodi
    \end{itemize}
    \item Un blocco di codice delimitato da parentesi graffe dovrebbe essere strutturato apponendo le parentesi graffe ognuna in una nuova riguarda;
...
\begin{enumerate}
    ...
    \item la versione \textit{major Z} (es: $X.y.z$) deve essere incrementata solo se nella documentazione è stata introdotta una modifica non retrocompatibile con le versioni precedenti (pubblicazione da parte del responsabile).
\end{enumerate}
