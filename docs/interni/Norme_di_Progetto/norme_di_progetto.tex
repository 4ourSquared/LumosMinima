...
%    \end{itemize}
\begin{itemize}
    \item Un \textit{blocco\textsubscript{G}} di codice delimitato da parentesi graffe dovrebbe essere strutturato apponendo le parentesi graffe ognuna in una nuova riga;
