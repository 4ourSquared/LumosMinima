...
\setdestuso{esterno}
\setdescrizione{
Questo documento descrive le funzionalità del programma a coloro che dovessero usufruirne in qualità di manutentore.
}
...
\addversione{0.1.0}{26/09/2023}{Alberti Nicolas}{Soldà Matteo}{Verifica per
\textit{PB}}
