...
\addversione{0.0.5}{25/05/2023}{Nicolas Alberti}{Erica Cavaliere}{Inserimento dello sprint 4; aggiornamento dei grafici di Gantt}
\addversione{0.0.6}{02/06/2023}{Brotto Romina}{}{Completamento sprint 5}
...
\textbf{Difficoltà incontrate:}
\begin{itemize}
    \item Alcune difficoltà nella precisa defiizione di alcuni sottocasi negli use case;
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}
    ...
    Romina & & & 2 & & & & 8(+2)\\
    \hline
    \textbf{Totale} & 9(+1) & 13.30(+0) & 18(+4) & 0(+0) & 4(+4) & 8(+2) & 51(+10)\\
    \hline
\end{tabular}\\[8pt]
