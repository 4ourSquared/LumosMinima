...
\setredattori{Alberti Nicolas \\ Cavaliere Erica \\ Soldà Matteo}
\setdestuso{esterno}
\setdescrizione{
...
\addversione{0.0.3}{30/05/2023}{Cavaliere Erica}{ }{Aggiunti nuovi vocaboli derivanti dall'\textit{Analisi dei requisiti}}
...
\section{A.}
\textbf{Area illuminata:} un luogo composto da \textit{impianti luminosi\textsubscript{G}} e sensori.
...
\textbf{Impianto luminoso:} la struttura di un lampione. \\ \\
